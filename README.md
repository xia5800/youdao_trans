...
| 翻译页 | 词典页 | 翻译记录页 | 翻译源设置页 |
| --- | --- | --- | --- |
| ![翻译页](img/翻译页.png) | ![词典页](img/词典页.png) | ![翻译记录页](img/翻译记录页.png) | ![翻译源设置页](img/翻译源设置页.png) |

| OCR设置页 | 语音播放设置页 | 偏好设置页 | 关于页 |
| --- | --- | --- | --- |
| ![OCR设置页](img/OCR设置页.png) | ![语音播放设置页](img/语音播放设置页.png) | ![偏好设置页](img/偏好设置页.png) | ![关于页](img/关于页.png) |
...
| 操作         | 方式                                      |
| ------------ | ----------------------------------------- |
| 🖱️ 打开翻译窗口 | 双击托盘图标，或托盘菜单 → 输入翻译       |
| 📸 截图翻译     | 默认快捷键 `Alt+W`，或托盘菜单 → 截图翻译 |
| ✂️ 划词翻译     | 选中文字后按 `Alt+T`（默认）              |
| ⌨️ 手动翻译     | 默认快捷键 `Ctrl+Enter`                   |
| 📖 查单词       | 托盘菜单 → 查单词                         |
| ⚙️ 全局快捷键   | 设置 → 全局快捷键设置                     |
...
- 🖥️ **前端**：Vue 3 + Vite + Vue Router
- 🦀 **后端**：Rust + Tauri 2.x
- 🗄️ **数据库**：SQLite (字典 + 历史记录)
- 👁️ **OCR**：PaddleOCR（本地离线） / 百度云 / 腾讯云 / 讯飞 / Ollama
